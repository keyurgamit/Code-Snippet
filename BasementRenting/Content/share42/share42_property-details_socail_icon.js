...
window.addEventListener('load', function () {
    ...
    for (var k = 0; k < e.length; k++) {
        if (e[k].className.indexOf('share42initpropertydetails') != -1) {
            ...
            if (!f) {
                ...
                f = path('share42_property-details_socail_icon.js');
            }
